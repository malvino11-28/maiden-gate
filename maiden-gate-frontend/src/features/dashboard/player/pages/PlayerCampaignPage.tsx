...
export default function PlayerCampaignPage() {
  ...
  const [activeSection, setActiveSection] = useState<PlayerCampaignSectionKey>("elementos");
  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-4 pb-12 pt-8 sm:px-6 lg:px-8">
      ...
      <div className="grid items-start gap-6 lg:grid-cols-[1fr_300px]">
        <div>
          <PlayerCampaignTabs activeSection={activeSection} onChange={setActiveSection} />
          ...
          {activeSection === "membros" && <PlayerMembersSection members={campaign.membros} />}
        ...
        >
          <div className="mb-3 flex flex-shrink-0 items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-amber-100">Rolar Dados</h3>
            <span className="ml-auto text-xs text-amber-100/30">{campaign.personagem.nome}</span>
          </div>
