...
export default function PlayerDiceChat({
  campaignId,
  characterId,
  characterName,
  userId,
          ...
          return (
            ...
            >
              <div className="mb-1 flex items-center justify-between">
                <span className="flex items-center gap-1 text-xs font-medium text-amber-100/50">
        ...
        <div className="grid grid-cols-4 gap-1.5">
          {diceOptions.map((dice) => (
            <button
              ...
              className="rounded-lg border border-amber-900/30 bg-slate-800/80 py-2 text-xs font-bold text-amber-100/70 transition-all hover:border-amber-500/50 hover:bg-amber-500/15 hover:text-amber-300 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >
              d{dice}
            </button>
          ))}
