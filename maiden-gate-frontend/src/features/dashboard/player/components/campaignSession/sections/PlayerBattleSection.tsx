...
export default function PlayerBattleSection({ currentLocation }: Props) {
  return (
    <div className="rounded-2xl border border-amber-900/25 bg-slate-900/60 p-8 text-center">
      ...
      <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-amber-100/45">
        Esta aba será usada para acompanhar encontros, turnos, inimigos e ações
        de combate. Por enquanto, as rolagens de dados continuam disponíveis no
        painel lateral.
      </p>
