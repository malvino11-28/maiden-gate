...
export default function ModalHeader({
  ...
  return (
    <header className="flex shrink-0 items-center justify-between border-b border-amber-900/30 bg-gradient-to-r from-amber-900/40 to-rose-900/40 px-6 py-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          {subtitle && (
            <p className="mt-0.5 text-sm text-amber-100/50">{subtitle}</p>
          )}
        </div>
      </div>
